    ...
    <div class="col-md-12">
      <div class="box box-info">
		...
		<?php
                ...
                echo form_open_multipart('admin/addUkm/',$name);
            ?>
		
				     <div class="form-group">
                 <label for="kategori" class="col-sm-3 control-label">Nama</label>
                    <div class="col-sm-9">
				             <input name="nama_ukm" class="form-control" placeholder="Nama">
                    </div>
				      </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <textarea id="editor1" name="visi" rows="5" cols="100"></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <textarea id="editor1" name="misi" rows="5" cols="100"></textarea>
                  <?php echo form_error('visi');?>
                </div>
              </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                <textarea id="editor1" name="sejarah" rows="8" cols="100"></textarea>
